...
public class Harmony extends AbstractMusicalTrait implements IMusicalTrait {
    ...
    // Factor to reduce number of generated chords by, when the "Enforce minimum consonance" paramenter is in effect.
    private static const ENFORCE_CONSONANCE_EASE_FACTOR:Number = 0.05;

    // Minimum number of chords to always generate per musical unit.
    private static const MIN_NUM_CHORDS:uint = 5;
    ...
    override public function execute(targetMusicUnit:IMusicUnit, analysisContext:IAnalysisContext,
        ...
        // The "Enforce minimum consonance" boolean parameter imposes a huge performance hit, while drammatically
        // improving the quality of the chords returned. It thus makes sense to deastically reduce the number of
        ...
        var isEnforcingConsonance:Boolean = (settings.getValueAt(enforceConsonanceParam, 0) === 1);
